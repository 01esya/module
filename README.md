...
- [Документация REST API](file:///API.md) — детальное описание серверных эндпоинтов, запросов и ответов.
- [История изменений (Changelog)](file:///CHANGELOG.md) — журнал релизов и версионирования.
- [Лицензия MIT](file:///LICENSE) — правила использования исходного кода.
